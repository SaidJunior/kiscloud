    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function getAjaxConfManager(){ 
                $.ajax({ 
                    type: "GET", 
                    url: "php/menu/ConfigurationManager.php", 
