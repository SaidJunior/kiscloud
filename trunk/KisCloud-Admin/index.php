...
<!--       LISTE NFS-->
	...
	$pdo_options[PDO::ATTR_ERRMODE] = PDO::ERRMODE_EXCEPTION;
	$bdd = new PDO('mysql:host=localhost;dbname=KISCLOUD', 'root', 'p@ssw0rd', $pdo_options);	
	$requetNFS = $bdd->query("SELECT * FROM NFS; "); // requette pour recup la liste des utilisateurs
	?>
  
	 <!-- Menu --> 
         <div class="tabbable tabs-left">			
            <ul class="nav nav-tabs">	
		<li class="active"><a href="#users" data-target="#users" data-toggle="tab"><h4>Manage Users</h4></a></li>
                <li><a href="#node" data-target="#node"data-toggle="tab"><h4>Manage Node</h4></a></li>
                <li><a href="#nfs" data-target="#nfs"data-toggle="tab"><h4>Manage NFS</h4></a></li>
		...
		<li><a href="#logs" data-target="#logs" data-toggle="tab"><h4>Logs</h4></a></li>
	 	 ...
	 	 <?php include("php/menu/ManageUser.php"); ?>
                 ...
                 <?php include("php/menu/ManageNFS.php"); ?>
